...
X_ref = XX;
figure
color_line3(XX(:,1),XX(:,2),0.*XX(:,1),dTA,'LineWidth',4);
%view(27,16)
axis equal;
grid;
...
F1 = figure
color_line3(X_data(:,1),X_data(:,2),0.*X_data(:,1),dTA,'LineWidth',4);
hold on
view(27,16)
axis equal;
grid;
...
%%
save_name = ['Exact_',func2str(func)]
save_name
...
%close all
F1 = figure
plot3(XX(:,1),XX(:,2),0.*XX(:,1), 'bx','markersize',16);
hold on
axis equal;
grid;
xlabel('$x$','interpreter','latex','fontsize',24)
